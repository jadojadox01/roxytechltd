        ...
        return (
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 duration-200 border rounded-lg border-gray-3 placeholder:text-sm h-11 placeholder:text-dark-5 outline-hidden focus:border-teal focus:ring-0"
            />
