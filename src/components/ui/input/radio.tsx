  ...
  return (
    <div>
      ...
      >
        ...
        <span className="flex size-4 items-center justify-center rounded-full border border-gray-4 peer-checked:border-4 peer-checked:border-teal dark:border-dark-3" />
