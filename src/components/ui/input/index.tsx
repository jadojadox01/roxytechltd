  ...
  return (
    <div>
      ...
      <input
        ...
        {...props}
        className={cn(
          "rounded-lg border placeholder:text-sm text-sm placeholder:font-normal border-gray-3 h-11  focus:border-teal focus:outline-0  placeholder:text-dark-5 w-full  py-2.5 px-4 duration-200  focus:ring-0",
          className,
          {
            "border-red": error,
          }
