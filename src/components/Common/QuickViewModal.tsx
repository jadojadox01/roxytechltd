                    ...
                    <div className="flex flex-col gap-5">
                      {product?.productVariants?.map((thumb, key: number) => (
                        <button
                          ...
                          key={key}
                          className={`flex items-center justify-center w-20 h-20 overflow-hidden rounded-lg bg-gray-1 ease-out duration-200 hover:border-2 hover:border-teal ${activePreview === key && "border-2 border-teal"
                            }`}
                        >
                          <Image
                            src={thumb.image}
                    ...
                    <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                      <div>
                        <button
                          ...
                          className="absolute z-50 flex items-center justify-center w-10 h-10 duration-200 ease-out bg-white rounded-lg gallery__Image shadow-1 text-dark hover:text-teal top-4 lg:top-8 right-4 lg:right-8"
                        >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="flex items-center justify-center w-10 h-10 duration-200 ease-out rounded-lg bg-gray-2 text-dark hover:text-teal"
                        >
